...
public class menu4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu4);btnConocelo = (Button) findViewById( R.id.btnConocelo);
        ...
        btnConocelo.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent i = new Intent(menu4.this, Informacion4.class);
                startActivity(i);
            }
        });
        ...
        btnPreparate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(menu4.this, preparate.class);
                startActivity(i);
            }
        });
