...
public class menu8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu8);btnConocelo = (Button) findViewById( R.id.btnConocelo);
        ...
        btnConocelo.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent i = new Intent(menu8.this, Informacion8.class);
                startActivity(i);
            }
        });
        ...
        btnPreparate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(menu8.this, preparate.class);
                startActivity(i);
            }
        });
