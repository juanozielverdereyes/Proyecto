...
public class menu7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu7);btnConocelo = (Button) findViewById( R.id.btnConocelo);
        ...
        btnConocelo.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent i = new Intent(menu7.this, Informacion7.class);
                startActivity(i);
            }
        });
        ...
        btnPreparate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(menu7.this, preparate.class);
                startActivity(i);
            }
        });
