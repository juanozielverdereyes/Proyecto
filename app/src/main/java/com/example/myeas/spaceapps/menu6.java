...
public class menu6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu6);btnConocelo = (Button) findViewById( R.id.btnConocelo);
        ...
        btnConocelo.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent i = new Intent(menu6.this, Informacion7.class);
                startActivity(i);
            }
        });
        ...
        btnPreparate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(menu6.this, preparate.class);
                startActivity(i);
            }
        });
